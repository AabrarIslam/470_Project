                ...
                while($row = mysqli_fetch_assoc($query_run)){
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <a href="user_unbook.php?rn=<?php echo $row['room_no']. "&rt=b";?>" class="btn btn-danger <?php if($row["status"]==0){echo "disabled";}else{echo "active";}?>" role="button" aria-disabled="<?php if($row['status']==0){echo "true";}else{echo "false";}?>">Unbook</a>
                        </div>
                    </div>
                    </div>
                    <?php
                ...
                while($row = mysqli_fetch_assoc($query_run)){
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <a href="user_unbook.php?rn=<?php echo $row['room_no']. "&rt=c";?>" class="btn btn-danger <?php if($row["status"]==0){echo "disabled";}else{echo "active";}?>" role="button" aria-disabled="<?php if($row['status']==0){echo "true";}else{echo "false";}?>">Unbook</a>
                        </div>
                    </div>
                    </div>
                    <?php
                ...
                while($row = mysqli_fetch_assoc($query_run)){
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <a href="user_unbook.php?rn=<?php echo $row['room_no']. "&rt=d";?>" class="btn btn-danger <?php if($row["status"]==0){echo "disabled";}else{echo "active";}?>" role="button" aria-disabled="<?php if($row['status']==0){echo "true";}else{echo "false";}?>">Unbook</a>
                        </div>
                    </div>
                    </div>
                    <?php
